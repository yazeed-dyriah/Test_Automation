...
// });
    ...
    // //TestCase (7) Try to observe the goal through select one topic with multiple group
    ...
    // //TestCase (8) Try to observe the goal through select a multiple levels 
    ...
    //TestCase (9) Try to observe all goals that are not observed
